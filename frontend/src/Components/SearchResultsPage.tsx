...
import { searchTravelPackages } from "../Redux/Slices/travelPackageSlice.reducer"; 
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-grow">
        <section className="container mx-auto px-4 py-12">
          <h2 className="text-5xl font-bold mb-8 text-center text-blue-800">Search Results</h2>
          {loading ? (
